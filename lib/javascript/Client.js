...
function Coverage_Calculator(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_Coverage_Calculator = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "Coverage_Calculator.run_Coverage_Calculator",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "Coverage_Calculator.status",
